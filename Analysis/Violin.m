classdef Violin < handle
            ...
            switch args.DataStyle
                case 'scatter'
                    if ~isempty(data2)
                        jitter = 1*(rand(size(data))); %right
                        obj.ScatterPlot = ...
                            scatter(pos + jitter.*jitterstrength, data, args.MarkerSize, 'filled','MarkerEdgeColor',[0 0 0],'LineWidth',0.5);
                        % plot the data points within the violin area
                        ...
                        obj.ScatterPlot2 = ...
                            scatter(pos + jitter.*jitterstrength, data2, args.MarkerSize, 'filled','MarkerEdgeColor',[0 0 0],'LineWidth',0.5);         
                    else 
                        obj.ScatterPlot = ...
                            scatter(pos + jitter.*jitterstrength, data, args.MarkerSize, 'filled','MarkerEdgeColor',[0 0 0],'LineWidth',0.5);
    ...
    methods (Access=private)
        function results = checkInputs(~, data, pos, varargin)
            ...
            p.addParameter('MarkerEdgeColor', [0.5 0.5 0.5], iscolor);
